                ...
                <div>
                    ...
                    >
                        <ul className="items-center space-y-8 md:flex md:space-x-6 md:space-y-0 ml-2">
                            ...
                            {navbar ? <Link to="/"><FontAwesomeIcon icon={faInstagram} /> Instagram</Link> : <Link to="/"><FontAwesomeIcon icon={faInstagram} /></Link>} 
                            </li>
                            <li className="text-black text-xl hover:text-blue-600">
                            {navbar ? <Link to="/"><FontAwesomeIcon icon={faFacebook} /> Facebook</Link> : <Link to="/"><FontAwesomeIcon icon={faFacebook} /></Link>}
                            </li>
                            <li className="text-black text-xl hover:text-blue-600">
                            {navbar ? <Link to="/"><FontAwesomeIcon icon={faTwitter} /> Twitter</Link> : <Link to="/"><FontAwesomeIcon icon={faTwitter} /></Link>}
                            </li>
                            <li className="text-black text-xl hover:text-blue-600">
                            {navbar ? <Link to="/"><FontAwesomeIcon icon={faUserAstronaut} /> Perfil</Link> : <Link to="/"><FontAwesomeIcon icon={faUserAstronaut} /></Link>}
                            </li>
                        </ul>
                    </div>
                </div>
