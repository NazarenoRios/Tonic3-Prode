...
const CustomUser = () => {
  ...
  const onSubmit = async  (data) => {
    ...
    const edit = await dispatch(editUser({name:data.name,lastname:data.lastname,email:usuario.email,state: data.state,city: data.city,address: data.address,zip: data.zip,phone: data.phone}))    
  }

  return (
    <>
    <Navbar2/> 
    <div className="flex h-screen"style={{backgroundImage:`url(${fondo})`}}>
          <div className="m-auto">
            <div className='flex justify-center pb-5'>
            <img className='rounded-full' src={avatar} alt="" style={{height:'100px'}}/>
            </div>
              ...
              <div className="flex flex-wrap -mx-3 mb-6">
                <div className="w-full md:w-1/2 px-3 mb-6 md:mb-0">
                  ...
                  <input
                    ...
                    />
                  {errors.name?.type === "required" && <span className="text-red-500 ml-8 sm:ml-0">* Select name </span>}
                </div>
                <div className="w-full md:w-1/2 px-3">
                  ...
                  <input
                    ...
                    />
                  {errors.lastname?.type === "required" && <span className="text-red-500 ml-8 sm:ml-0">* Select last Name </span>}
                </div>
              </div>
              <div className="flex flex-wrap -mx-3 mb-6">
